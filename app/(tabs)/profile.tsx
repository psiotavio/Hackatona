...
import {
	observarPontosUsuario,
	calcularMaximoPontosPorDia,
} from "@/services/firebase/fetchMaxPoints";
...
export default function ProfileScreen() {
	...
	const [isPublicQuestionModalVisible, setIsPublicQuestionModalVisible] =
		useState(false);
